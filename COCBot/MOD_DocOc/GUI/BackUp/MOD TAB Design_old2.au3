...
Global $chkEnableTrCollect = 0, $chkForceTrCollect = 0, $chkGoldTrCollect = 0, $txtMinGoldTrCollect = 0, $txtMinElxTrCollect = 0, $chkFullElxTrCollect = 0, $chkDarkTrCollect = 0, $txtMinDarkTrCollect = 0, $chkFullDarkTrCollect = 0, $chkElxTrCollect=0
